...
pub struct Deposit<'info> {
    ...
    pub mint: InterfaceAccount<'info, Mint>, // mint account for the token we are trying to deposit
    ...
    pub bank: Account<'info, Bank>, // the bank we gonna be depositing into
    ...
    pub bank_token_account: InterfaceAccount<'info, TokenAccount>, // the tokens we are depositing into the bank token account
    ...
    pub user_account: Account<'info, User>, // the user account
    ...
    pub user_token_account: InterfaceAccount<'info, TokenAccount>,  // token account of the user through which tokens will be sent
