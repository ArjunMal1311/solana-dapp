...
declare_id!("Dqaic33RBPbacPSUR6NvtNffZzt8xdvvmbe3J2LbTk4w");

#[program]
pub mod voting {
    use super::*;

    pub fn initialize_poll(ctx: Context<InitializePoll>, _poll_id: u64, start_time: u64, end_time: u64, name: String, description: String) -> Result<()> {
...
pub struct InitializePoll<'info> {
    ...
    #[account(
        ...
        seeds = [b"poll".as_ref(), poll_id.to_le_bytes().as_ref()], // -> poll : [112, 111, 108, 108] and if poll_id : 42 to le_bytes [42, 0, 0, 0, 0, 0, 0, 0] so b"poll", poll_id.to_le_bytes() -> [112, 111, 108, 108, 42, 0, 0, 0, 0, 0, 0, 0]
        bump
    )]
