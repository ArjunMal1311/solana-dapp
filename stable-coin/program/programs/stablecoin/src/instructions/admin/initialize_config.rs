...
pub struct InitializeConfig<'info> {
    ...
    pub config_account: Account<'info, Config>, // config account storing authority, mint_account, liquidation_threshold, liquidation_bonus, min_health_factor, bump, bump_mint_account
    ...
    pub mint_account: InterfaceAccount<'info, Mint>, // mint account - mint authority, freeze_authority, decimals, bump
